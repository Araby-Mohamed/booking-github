...
<div class="row">
  <div class="col-sm d-flex justify-content-between">
    ...
    <div>
      <a href="{{ route('export.email', ['date' => $dates[0]['date']->toDateString()]) }}" class="btn btn-secondary mb-2">تصدير عناوين البريد الإلكتروني</a>
      <a href="{{ route('print', ['date' => $dates[0]['date']->toDateString()]) }}" class="btn btn-secondary mb-2">طباعة <i class="fas fa-print fa-sm"></i></a>
      @can('add.booking')
      <a href="{{ route('booking.create') }}?date={{ $dates[0]['date']->toDateString() }}" class="btn btn-success mb-2">حجز جديد</a>
      @endcan
    </div>
  </div>
</div>

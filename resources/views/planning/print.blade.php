...
<div class="row">
  <div class="col-sm d-flex justify-content-between">
    <div>
      ...
      <a href="{{ route('print') }}" class="btn btn-secondary mb-2">اليوم</a>
    </div>

    <div>
      <a href="#" id="printBtn" class="btn btn-secondary mb-2 js-print">طباعة <i class="fas fa-print fa-sm"></i></a>
    </div>
  </div>
</div>
{{-- notes --}}
                ...
                <div class="booking-card">
                  ...
                  <ul class="fa-ul">
                    ...
                    @if($b->properties->options['asWhole'])
                      <li><span class="fa-li"><i class="far fa-check-square"></i></span>محجوزة بالكامل</li>
                    @endif
                  </ul>
                </div>
                <hr />

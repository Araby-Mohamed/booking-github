...
@endif
  ...
  <div class="row justify-content-md-center">
    <div class="col-6">
      <div class="form-group">
        <label for="arrivalInput">وصول</label>
      ...
      <div class="form-group">
        <label for="departureInput">مقال</label>
        <div class="input-group date">
      ...
      <div class="form-group">
        <label for="guestsSelect"># ضيوف</label>
    ...
    <div class="col-6">
      <div class="form-group">
        <label for="roomSelect">غرفة</label>
          ...
          @foreach($rooms as $room) {{-- all rooms --}}
            ...
            @if (count($room->layout) > 1)
              @foreach($room->layout as $l)
                ...
                value="{{ $room->id }};{{ $loop->index }}">-- غرفة {{ $loop->iteration }}</option>
              @endforeach
            @endif
          @endforeach
        </select>
      ...
      <div class="form-group">
        <label for="basePriceInput">السعر الأساسي</label>
      ...
      <div class="form-group">
        <label for="depositInput">الوديعة</label>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text">€</span>
          </div>
  ...
  <div class="row justify-content-md-center mt-4">
    <div class="col-12">
      <div class="form-group">
        <label for="compositionTextArea">مجمع</label>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12">
      <div class="form-group">
        <label for="commentTextArea">ملاحظات / معلومات إضافية</label>
    ...
    @if(isset($booking))
      <a href="{{ route('booking.delete', $booking) }}" class="btn btn-danger">حذف الحجز</a>
      <button type="submit" class="btn btn-primary float-right">حفظ!</button>
    @else
      <button type="submit" class="btn btn-primary float-right">اضافة!</button>
    @endif
  </fieldset>
</form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ضيف جديد</h5>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" id="saveGuest">حفظ</button>
      </div>
    </div>
  </div>
</div>

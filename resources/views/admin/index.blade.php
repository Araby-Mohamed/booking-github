        ...
        <div class="tab-pane fade" id="password">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('passwd') }}">
                ...
                <div class="form-group row">
                    <label for="current-password" class="col-sm-3 offset-sm-2 col-form-label">كلمة المرور الحالي</label>
                    <div class="col-sm-5">
                        <input id="current-password" type="password" class="form-control" name="current-password" required autofocus>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="new-password" class="col-sm-3 offset-sm-2 col-form-label">كلمة المرور الجديدة</label>
                    <div class="col-sm-5">
                        <input id="new-password" type="password" class="form-control" name="new-password" required autofocus>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="new-password_confirmation" class="col-sm-3 offset-sm-2 col-form-label">كرر كلمة المرور الجديدة</label>
                    <div class="col-sm-5">

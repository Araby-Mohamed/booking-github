    ...
    <fieldset>
        ...
        <div class="col-sm-8 offset-sm-2">
            <div class="form-group row">
                <label for="usernameInput" class="col-sm-4 col-form-label">اسم المستخدم</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="nameInput" class="col-sm-4 col-form-label">الاسم</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="emailInput" class="col-sm-4 col-form-label">البريد الإلكتروني</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="role" class="col-sm-4 col-form-label">دور</label>
                <div class="col-sm-8">
